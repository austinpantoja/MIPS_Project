...
int instruction_fetch(unsigned PC,unsigned *Mem,unsigned *instruction)
{
    ...
    else // Halt condition occured - counter was not a multiple of 4 or was out of range
        return 1;
}
...
{
    *data1 = Reg[r1]; // Assign value of register r1 to data1
    *data2 = Reg[r2]; // Assign value of register r2 to data2
}
